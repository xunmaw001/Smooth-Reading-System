        ...
        <div v-else>
	      ...
	      <el-input v-model="ruleForm.shifouwanjie"
                placeholder="是否完结" readonly></el-input>
                                                                                              ...
                                                                                              <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容1" prop="neirong1">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="内容1"
                  v-model="ruleForm.neirong1" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.neirong1" label="内容1" prop="neirong1">
                    <span>{{ruleForm.neirong1}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容2" prop="neirong2">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="内容2"
                  v-model="ruleForm.neirong2" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.neirong2" label="内容2" prop="neirong2">
                    <span>{{ruleForm.neirong2}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容3" prop="neirong3">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="内容3"
                  v-model="ruleForm.neirong3" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.neirong3" label="内容3" prop="neirong3">
                    <span>{{ruleForm.neirong3}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.neirong1 = true;
            continue;
          }
	            	            if(o=='neirong2'){
            this.ruleForm.neirong2 = obj[o];
	    this.ro.neirong2 = true;
            continue;
          }
	            	            if(o=='neirong3'){
            this.ruleForm.neirong3 = obj[o];
	    this.ro.neirong3 = true;
            continue;
          }
	            	            if(o=='zuozhe'){
