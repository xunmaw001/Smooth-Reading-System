	...
	<view class="content">
		<form class="app-update-pv">
			...
			<!-- 否 -->
				...
				<view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 0, 0, 1)","textAlign":"left"}' class="title">备注</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`koufeixinxi`, this.ruleForm.id);
			...
			async onSubmitTap() {
				...
				await this.$api.update(`${table}`, obj);
					...
					return
																																				...
																																				if(this.ruleForm.id){
					await this.$api.update(`koufeixinxi`, this.ruleForm);
				}else{
					await this.$api.add(`koufeixinxi`, this.ruleForm);
				}
